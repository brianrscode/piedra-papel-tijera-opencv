...
class HandsDetector:
    ...
    def find_position_landmarks(self, frame, hand_no=0, draw=True) -> List[int]:
    ...
    def distance(self, p1, p2, frame, draw=True, line_width=2) -> Tuple[float, np.ndarray, list[int]]:
